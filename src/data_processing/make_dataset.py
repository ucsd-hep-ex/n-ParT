...
def main(args):
    ...
    save_path = f"/j-jepa-vol/n-ParT-Zihan/data/top/{label}"
    ...
    with h5py.File(f"{save_path}/{label}{args.tag}.h5", "w") as hdf:
        hdf.create_dataset("features", data=features_array)
